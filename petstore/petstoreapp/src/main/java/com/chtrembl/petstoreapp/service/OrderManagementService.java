...
public class OrderManagementService {
    ...
    public void updateOrder(long productId, int quantity, boolean completeOrder) {
        ...
        try {
            ...
            // Notify OrderItemsReserver Azure Function to persist the order as a blob
            // Uses session ID as the blob file name so it is overwritten on each cart update
            orderItemsReserverClient.reserveOrderItems(orderJSON);
